            ...
            child: Column(
              children: <Widget>[
                    ...
                    children: [
                      Flexible(
                        child: LREntryBox(
                          ...
                          label: 'First Name',
                          keyboard: 'name',
                          rowPlacement: RowPlacement.left,
                        ),
                      ),
                      ...
                      Flexible(
                        child: LREntryBox(
                          ...
                          label: 'Last Name',
                          keyboard: 'name',
                          rowPlacement: RowPlacement.right,
                        ),
                      ),
                    ],
                  ),
                ...
                LREntryBox(
                  ...
                  keyboard: 'password',
                  isPassword: true,
                  // This returns a validator that is always true when the passwords match
                  // and one that is always false when they do not match
                  validator: _confirmPasswordController.text == _passwordController.text ? 
                            MinLengthValidator(0,errorText: "") : 
                            MaxLengthValidator(0,errorText: "Passwords must match"),
                  autovalidate: true
                ),
